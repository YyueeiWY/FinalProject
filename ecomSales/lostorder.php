   ...
   if(isset($_POST['submit'])){
	   ...
	   $sortby = 'B.date ASC LIMIT 0, 10';
		...
		$query = "SELECT B.id, A.payid
				FROM payment A RIGHT JOIN productorder B ON A.id = B.payid";
		...
		*/
		...
		<div class="news col-md-12 m-t-20">
			...
			<div><label><strong>Shipping Code :</strong></label></div>
				...
				<div class="row">
					<div class="col-md-4">Promo Code : <strong><?php echo 'Undefine'; ?></strong></div>
					<div class="col-md-4">Product Price : <strong><?php echo 'Undefine'; ?></strong></div>
